            ...
            <div class="col-md-12">
                ...
                <div class="card-body">
                    <form action="../control/acoes.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label >Nome</label>
                            <input type="text" name="nome" value="<?= htmlspecialchars($produto['nome']); ?>" class="form-control">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="int" name="quantidade" value="<?= htmlspecialchars($produto['quantidade']); ?>" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label >Preço</label>
                            <input type="float" name="preco" value="<?= htmlspecialchars($produto['preco']); ?>" class="form-control">
                        </div>
                        <div class="mb-3">
